...
impl Storage {
    pub fn save_routine_run(&self, run: &RoutineRun) -> SqlResult<()> {
        self.conn.execute(
    ...
    pub fn load_routine_runs(&self, routine_id: &str) -> SqlResult<Vec<RoutineRun>> {
...
mod tests {
    ...
    fn test_update_routine_run_status() {
        ...
        storage
            .update_routine_run_status("run1", RunStatus::Failed, Some(1700000002000))
            .unwrap();
